...
//    var tt = document.createTextNode (feelings[feelingcount1]);
...
//function chooseOne (feeling_chosen)
...
function myRide() {
var value1="value1 Apples";
var value2="value2 Oranges";
...
function myChoosing(thechoice){
    if(thechoice == 1){
  var queryString = "?choice=" + feelings[feelingcount1];
  window.location.href = "./eia_B_next.html" + queryString;
        } else  {
  var queryString = "?choice=" + feelings[feelingcount2];
  window.location.href = "./eia_B_next.html" + queryString;  
